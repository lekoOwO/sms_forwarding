...
static constexpr uint8_t IDF_MODEM_MSSLCIPHER_SUMMARY_VERSION = 1;
static constexpr uint8_t IDF_MODEM_MSSLCIPHER_SUMMARY_C02B = 0x01;
static constexpr uint8_t IDF_MODEM_MSSLCIPHER_SUMMARY_C02C = 0x02;
static constexpr uint8_t IDF_MODEM_MSSLCIPHER_SUMMARY_C02F = 0x04;
static constexpr uint8_t IDF_MODEM_MSSLCIPHER_SUMMARY_C030 = 0x08;
static constexpr uint8_t IDF_MODEM_MSSLCIPHER_SUMMARY_KNOWN_MASK = 0x0F;
static constexpr uint16_t IDF_MODEM_MSSLCIPHER_SUMMARY_MAX_COUNT = 0xFFFF;
