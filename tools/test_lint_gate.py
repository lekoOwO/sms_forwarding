...
class LintGateTests(unittest.TestCase):
    def assert_host_contracts(self, workflow):
        ...
        self.assertEqual([
            ...
            "python3 components/idf_lpa/test/test_install.py",
            "python3 components/idf_lpa/test/test_activation_code.py",
            "python3 tools/test_tls_certificate_bundle.py --native",
            ...
            "python3 components/idf_web/test/test_esim_install.py",
